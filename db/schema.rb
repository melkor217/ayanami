...
ActiveRecord::Schema.define(version: 20160617085407) do
  ...
  create_table "hlstats_PlayerUniqueIds", primary_key: ["uniqueId", "game"], force: :cascade, options: "ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin" do |t|
    t.integer  "playerId",                    default: 0,  null: false, unsigned: true
  ...
  create_table "hlstats_Players", primary_key: "playerId", unsigned: true, force: :cascade, options: "ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin" do |t|
    ...
    t.index ["game"], name: "game", using: :btree
    t.index ["hideranking", "flag"], name: "lel", using: :btree
